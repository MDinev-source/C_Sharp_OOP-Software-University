namespace Aquariums.Tests
{
    ...
    {
        [Test]
        public void ConstructorShouldInitializeCorrectlyAllPropertioes()
        {
            string name = "Strange";
            int capacity = 10;
        ...
        [Test]
        public void RemoveFishShouldThrowExceptionWhenIsNameNotFound()
        {
        ...
        [Test]
        public void SellFishShouldThrowExceptionWhenIsNameNotFound()
        {
        ...
        public void ValidateReportMessage()
        {
            ...
            string expexctedResult = "Fish available at Strange: Nemo, Nemo2";
